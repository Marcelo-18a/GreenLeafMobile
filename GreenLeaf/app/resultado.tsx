...
export default function ResultadoScreen() {
    // Captura os parâmetros exatos e fixos passados pela Câmera ou pelo Histórico
    ...
    // Monta as recomendações técnicas baseando-se estritamente no status fixo do registro
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.photoCard}>
                    ...
                    <View style={styles.photoTag}>
                        ...
                        <Text style={styles.photoTagText}>Registro do Histórico</Text>
                    </View>
                </View>

                {/* Bloco de Resultado Fixo */}
                <View style={styles.resultBlock}>
                    ...
                    {/* Gráfico Redondo de Porcentagem Fixo */}
                ...
                {/* Recomendações de Manejo Técnico Amarradas ao Diagnóstico */}
