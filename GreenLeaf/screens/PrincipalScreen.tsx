...
function ActionCard({ icon, text }: { icon: ReactNode; text: string }) {
    return (
            ...
            <ScrollView contentContainerStyle={[styles.content, compact && styles.contentCompact]} showsVerticalScrollIndicator={false}>
                <View style={styles.userRow}>
                    <TouchableOpacity activeOpacity={0.8} style={[styles.avatarCircle, compact && styles.avatarCircleCompact]}>
                        <FontAwesome5 name="user" size={compact ? 18 : 26} color="#d6d6d6" solid />
                    </TouchableOpacity>
                    ...
                    <View style={[styles.headerActions, compact && styles.headerActionsCompact]}>
                        <TouchableOpacity activeOpacity={0.8} style={[styles.smallIconCircle, compact && styles.smallIconCircleCompact]}>
                            <Ionicons name="notifications" size={compact ? 12 : 16} color="#4f4f4f" />
                            <View style={styles.notifyDot} />
                        </TouchableOpacity>

                        <TouchableOpacity activeOpacity={0.8} style={[styles.smallIconCircle, compact && styles.smallIconCircleCompact]}>
                            <Ionicons name="search" size={compact ? 12 : 16} color="#4f4f4f" />
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <View style={[styles.cardsArea, compact && styles.cardsAreaCompact]}>
                    ...
                    <ActionCard icon={<Ionicons name="location-outline" size={compact ? 19 : 25} color="#4f4f4f" />} text="Visualizar mapa de calor" />
                </View>
            </ScrollView>
